...
var monitor = (bot, conversionConfig) => {
  ...
  builder.IntentDialog.prototype.dialogResumed = (function() {
    var orig = builder.IntentDialog.prototype.dialogResumed;
    return function (session, result) {
      var _dialog = this;
      var activeIntent = session.dialogData['BotBuilder.Data.Intent'];

      orig.apply(_dialog, [session, result]);
    }
  });
