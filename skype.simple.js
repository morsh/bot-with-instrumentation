            ...
            .attachments([
                new builder.HeroCard(session)
                    ...
                    .buttons([
                        ...
                        builder.CardAction.openUrl(session, "https://en.wikipedia.org/wiki/Thor", "Thor"),
                        builder.CardAction.imBack(session, "select:100", "Select"),
                        builder.CardAction.playVideo(session, "https://www.youtube.com/watch?v=g6BK5Q_Dblo", "Yuval Harari")
                    ]),
                new builder.HeroCard(session)
